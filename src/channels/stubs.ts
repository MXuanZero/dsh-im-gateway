...
export function createTlonChannel(config: TlonChannelConfig, log: (line: string) => void): ChannelAdapter | undefined {
...
export function createYuanbaoChannel(config: YuanbaoChannelConfig, log: (line: string) => void): ChannelAdapter | undefined {
...
export function createVoiceChannel(config: VoiceChannelConfig, log: (line: string) => void): ChannelAdapter | undefined {
  if (config.enabled !== true) return undefined
  let stopped = false
  return {
    id: 'voice',
